...
const LEDGER: LedgerRow[] = [
  ...
  ["packages/engine/src/execution/reviewer.ts",570,"A","options.store","TaskStore","reviewer TaskStore"],
  ["packages/engine/src/merger.ts",373,"A","store","TaskStore","merger TaskStore"],
  ["packages/engine/src/merge/merger-ai.ts",536,"A","store","TaskStore","merger AI TaskStore"],
  ["packages/engine/src/merge/merger-ai.ts",609,"A","store","TaskStore","merger AI TaskStore"],
  ...
  ["packages/engine/src/triage.ts",3292,"A","this.store","TaskStore","triage TaskStore"],
  ["packages/engine/src/scheduling/cron-runner.ts",1073,"A","store","TaskStore","cron TaskStore"],
  ["packages/engine/src/missions/mission-execution-loop.ts",966,"A","this.taskStore","TaskStore","mission TaskStore"],
  ...
  ["packages/dashboard/src/chat.ts",3055,"A","this.taskStore","TaskStore","chat scoped TaskStore"],
  ["packages/dashboard/src/planning.ts",129,"A","store","TaskStore","planning TaskStore"],
  ["packages/dashboard/src/milestone-slice-interview.ts",839,"A","store","TaskStore","milestone TaskStore"],
  ["packages/dashboard/src/mission-interview.ts",951,"A","store","TaskStore","mission interview TaskStore"],
  ["packages/dashboard/src/agent-generation.ts",505,"A","store ?? {}","TaskStore","optional store resolves as TaskStore when present"],
  ["packages/dashboard/src/pr-conflict-resolver.ts",178,"A","store","TaskStore","conflict resolver TaskStore"],
