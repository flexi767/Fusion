...
- Pending: managed launch replacement and other native runtime backends; operator-selected retention; native-hook latency and real per-host control verification; remaining identities/m5; price-date comparison; production rollout, 24-hour dual run and rollback rehearsal.
