...
- Still open: all-host controls/native-hook verification and other native runtime backends; remaining identity/content reconciliation; parser-state retention policy; sustained lag/outage/rollback evidence; m5; production entry-point switch after parity. No automatic task enrollment occurs.
