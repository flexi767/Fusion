...
| Archive/pins/notes | Six archived; zero pinned; zero notes | Independent preferences and revision-fenced notes; importer preserves mapped records | All six archive labels resolved through two canonical cards and four verified aliases; format-5 replay pending |
